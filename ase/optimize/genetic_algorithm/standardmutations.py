...
from ase.optimize.genetic_algorithm.utilities import atoms_too_close
from ase.optimize.genetic_algorithm.utilities import atoms_too_close_two_sets
from ase import Atoms


class MutationSelector(object):
    """ Class used to randomly select a mutation from a list of mutations.
        ...
        mutlist: The list of mutations to select from.
    """
    def __init__(self, probabilities, mutlist):
        assert len(probabilities) == len(mutlist)
    ...
    def mutate(self, candidate):
        ...
        return self.mutlist[to_use].mutate(candidate)


class RattleMutation(object):
    ...
    """
    def __init__(self, blmin, n_top, rattle_strength=0.8, rattle_prop=0.4):
        self.blmin = blmin
        self.n_top = n_top
...
class PermutationMutation(object):
    ...
    def __init__(self, n_top, probability=0.33):
        self.n_top = n_top
...
class MirrorMutation(object):
    ...
    """
    def __init__(self, blmin, n_top, reflect=False):
        self.blmin = blmin
        self.n_top = n_top
